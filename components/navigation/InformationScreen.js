        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    <Text style={styles.text1}>Tilføj din tilgængelighed</Text>
                </View>

                <View style={styles.container2}>
                    <MenuProvider style={{alignItems: 'center', justifyContent: 'center', padding: 50}}>
                        <Menu onSelect={value => alert(`Dit valg: ${value}`)}>

                            <MenuTrigger  >
                                <Text style={styles.headerText}>Vælg timer om ugen</Text>

                            </MenuTrigger  >
                            //Menu for information loades
                            <MenuOptions>
